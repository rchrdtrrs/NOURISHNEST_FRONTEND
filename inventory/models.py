...
class DietaryTag(models.Model):
    """Tags for dietary classifications (e.g., Vegan, Gluten-Free, High-Protein)."""
...
class InventoryItem(models.Model):
    """Tracks ingredients/items in user's inventory."""
    ...
    quantity = models.CharField(
        max_length=100,
        help_text="Quantity with unit (e.g., '500g', '2 cups', '1 dozen')"
    )
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['user', 'perishable']),
        ]
...
class UserHistory(models.Model):
    """Tracks user actions for undo functionality and audit logging."""
    ...
    model_affected = models.CharField(
        max_length=100,
    ...
    metadata = models.JSONField(
        default=dict,
        help_text="Additional data for undo operations (old values, etc.)"
    )
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['user', 'is_undone']),
        ]
